...
In this R markdown file, we search for DTXSIDs using the ctxR package.
We leverage the InchiKey values which we obtained from the ChEMBL API.
...
The final dataset is "activities_with_dsstoxids.csv."
Chunks after this point are purely exploratory 


```{r}
dataf <- read_csv("activities_with_dsstoxids.csv") # this the current search through chembl
